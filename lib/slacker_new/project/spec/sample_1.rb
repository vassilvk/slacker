...
describe 'My database' do
  ...
  it 'contains system tables' do
    # Make sure we haev at least one system objects in the database
  ...
  it 'contains system tables (take two)' do
    # Every (*.sql.erb) file in folder "sql" can be called as a method of the "sql" object.
    # Subfolders of the "sql" appear as children of the "sql" object with their templates automatically available as methods.
